    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceDeviceParameter", x => new { x.DeviceId, x.DeviceParametersId });
                    table.ForeignKey(
                        name: "FK_DeviceDeviceParameter_DeviceParameters_DeviceParametersId",
                        column: x => x.DeviceParametersId,
                        principalTable: "DeviceParameters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeviceDeviceParameter_Devices_DeviceId",
                        column: x => x.DeviceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceParameterValues", x => new { x.DeviceParameterId, x.DeviceId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeviceParameterValues_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceDeviceParameter_DeviceParametersId",
                table: "DeviceDeviceParameter",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceParameterValues_DeviceId",
